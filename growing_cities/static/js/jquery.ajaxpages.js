...
(function(window, undefined){
	...
	$(function(){
		...
		var
            ...
            // Events
            startedEventName = 'statechangestart',
		...
		$window.bind('statechange',function(){
			...
			$.ajax({
				...
				success: function(data, textStatus, jqXHR){
                    ...
                    // Store fiber-data in body as given by the incoming page's 
                    // body.
                    $(document.body).attr('data-fiber-data', $dataBody.attr('data-fiber-data'));
