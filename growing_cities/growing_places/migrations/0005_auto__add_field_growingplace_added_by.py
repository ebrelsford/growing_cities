...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GrowingPlace.added_by'
        db.add_column(u'growing_places_growingplace', 'added_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GrowingPlace.added_by'
        db.delete_column(u'growing_places_growingplace', 'added_by_id')
    ...
    models = {
        ...
        u'growing_places.growingplace': {
            ...
            'activities': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['growing_places.Activity']", 'null': 'True', 'blank': 'True'}),
