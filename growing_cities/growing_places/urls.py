...
from .views import (AddPlaceView, AddPlaceSuccessView, CityBBOXView,
                    FindCityView, FindPlacesView, GrowingPlacesGeoJSONListView)


urlpatterns = patterns('',
    url('^citybbox/', CityBBOXView.as_view(), name='gcplace_citybbox'),
    url('^city/find/', FindCityView.as_view(), name='gcplace_city_find'),
    url('^places/add/success/$', AddPlaceSuccessView.as_view(),
        name='gcplace_place_add_success'),
